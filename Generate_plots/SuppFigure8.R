...
pdf("SFig8a.pdf", width = 15, height = 10)
netVisual_chord_gene(object.list[[1]], sources.use = 11, slot.name = "netP", small.gap = 3,
                     title.name = paste0("", names(object.list)[1]))

netVisual_chord_gene(object.list[[2]], sources.use = 11, slot.name = "netP", small.gap = 3,
                     title.name = paste0("", names(object.list)[2]))
dev.off()

#Signaling pathways with FRC1 as source 
pdf("SFig8b.pdf", width = 15, height = 10)
netVisual_chord_gene(object.list[[1]], sources.use = 12, slot.name = "netP", small.gap = 3,
                     title.name = paste0("", names(object.list)[1]))

netVisual_chord_gene(object.list[[2]], sources.use = 12, slot.name = "netP", small.gap = 3,
                     title.name = paste0("", names(object.list)[2]))
dev.off()

#Signaling pathways with FRC2 as source 
pdf("SFig8c.pdf", width = 15, height = 10)
netVisual_chord_gene(object.list[[1]], sources.use = 13, slot.name = "netP", small.gap = 3,
                     title.name = paste0("", names(object.list)[1]))

netVisual_chord_gene(object.list[[2]], sources.use = 13, slot.name = "netP", small.gap = 3,
                     title.name = paste0("", names(object.list)[2]))
dev.off()