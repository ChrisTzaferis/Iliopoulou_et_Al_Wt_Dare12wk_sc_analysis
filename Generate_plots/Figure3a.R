...
#---UMAP plot for WT---
umap1 <- DimPlot_scCustom(obj_list[[1]], group.by = "annotation", colors_use = c("skyblue1","slateblue4", 
                                                                                 "salmon1", "yellow4", "thistle", "yellow3", 
...
#---UMAP for DARE---
umap2 <- DimPlot_scCustom(obj_list[[2]], group.by = "annotation", colors_use = c("skyblue1","slateblue4", 
                                                                                 "salmon1", "yellow4", "thistle", "yellow3", 
                                                                                 "red2","yellowgreen", "mediumorchid2",
                                                                                 "wheat3", "royalblue", "orange","grey70","tan3"), 
                          figure_plot = T, 
...
umap3 <- DimPlot_scCustom(obj, group.by = "annotation", colors_use = c("skyblue1","slateblue4", 
                                                                       "salmon1", "yellow4", "thistle", "yellow3", 
                                                                       "red2","yellowgreen", "mediumorchid2",
                                                                       "wheat3", "royalblue", "orange","grey70","tan3"),
)
...
ggsave("Fig3a.pdf", device = "pdf", width = 39, height = 17, units = "cm", dpi = 600)
