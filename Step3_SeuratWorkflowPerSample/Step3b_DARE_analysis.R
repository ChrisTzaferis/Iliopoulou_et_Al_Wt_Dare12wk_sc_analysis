...
#dare:
# before filtering: 22708 cells
# nFeature_RNA > 800 & nFeature_RNA < 7500 & percent.mt < 5 : 20489 cells
...
#annotation DARE
new.cluster.ids <- c("Lymphoid", "Myeloid", "Lymphoid", "Stroma", "Myeloid", "Stroma", "Stroma", "Stroma")
