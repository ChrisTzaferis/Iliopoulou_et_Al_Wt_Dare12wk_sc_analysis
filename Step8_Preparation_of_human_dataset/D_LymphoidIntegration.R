...
obj1 <- readRDS("TI_Lymphoid_Human_with_mouse_genes.RDS")
head(obj1@meta.data)
...
#load DARE+WT object
obj2 <- readRDS("../Step7_Annotation_of_clusters/WT12wk_DARE12Wk_Lymphoid_annotated.RDS")
head(obj2@meta.data)
...
saveRDS(obj.combined, "lymphoid_integration.RDS")
