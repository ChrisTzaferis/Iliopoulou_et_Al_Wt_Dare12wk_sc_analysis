...
#WT objcect containing Lymphoid, Myeloid, Stroma
curObj <- readRDS("WT12_cellchatInput.RDS")
...
# The cell groups used for CellChat analysis are  Activated_Mfs B_cells Cajal Capillary_ECs Cd8_T_cells Cdc1 Cdc2_a Cdc2_b 
# Cycling_B_cells Cycling_T_cells FDCs_MRCs FRC1 FRC2 Granulocytes ILC2s ILC3s Intermediate_Mfs LECS Memory_T_cells 
# Mesothelial Monocytes Naïve_CD4_T_cells Naïve_CD8_T_cells NKT_cells pDCs Pdgfra_low Pericytes Plasma_cells Resident_Mfs 
# SMCs Tcr_gammadelta Telocytes Th17_cells Tregs Trophocytes Vein_ECs 
...
ggsave(filename="k_outgoing_WT12.png", plot = k1, width=12, height=6, units = "cm")

k2 <- selectK(cellchat, pattern = "incoming") #
ggsave(filename="k_incoming_WT12.png", plot = k2, width=12, height=6, units = "cm")
...
saveRDS(cellchat, "cellchat_WT12_final.RDS")
